    ...
    <>
      <FullContainer>
        <SmallContainer noBottomPadding>
          <Sections withPadding title="United States Job Postings">
        ...
        <div className="chart-slider">
          ...
          >
            <SingleLineChart
              ...
              chartDiv="national-debt-chart"
              stokeColor="#f2612d"
            />
            <SingleLineChart
              title={"Fed Balance Sheet"}
              subtitle={"In Trillions USD"}
              chartDiv="fed-balance-sheet-chart"
              stokeColor="#f2612d"
            />
            <SingleLineChart
              title={"US Dollar"}
              subtitle={"US Dollar Index (DXY)"}
              chartDiv="us-dollar-chart"
              stokeColor="#f2612d"
            />
            <SingleLineChart
              title={"Inflation Rate"}
              subtitle={"Percent"}
              chartDiv="inflation-rate-chart"
              stokeColor="#f2612d"
            />
            <SingleLineChart
              title={"Loan to the Private Sector"}
              subtitle={"In Trillions USD"}
              chartDiv="loan-private-sector-chart"
              stokeColor="#f2612d"
            />
            <SingleLineChart
              title={"US Money Supply"}
              subtitle={"In Trillions USD"}
              chartDiv="us-money-supply-chart"
              stokeColor="#f2612d"
            />
          </Carousel>
        </div>
