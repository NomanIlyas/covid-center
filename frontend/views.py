...
def index(request):
    ...
    for key in overview:
        if country:
            ...
            Country.objects.filter(name=country.name).update(name=country.name,total_cases=country.total_cases,new_cases=country.new_cases, new_recovered= country.new_recovered,total_death=country.total_death,new_death=country.new_death,total_recovered=country.total_recovered,active_cases=country.active_cases,serious_critical=country.serious_critical,total_cases_1m_pop=country.total_cases_1m_pop,deaths_1m_pop=country.deaths_1m_pop,total_test=country.total_test,test_1m_pop=country.test_1m_pop,population=country.population,date=country.date)
        else:
            ...
            date = datetime.today()
            covid_record= Country.objects.create(name=name,total_cases=total_cases,new_cases=new_cases, new_recovered= new_recovered,total_death=total_death,new_death=new_death,total_recovered=total_recovered,active_cases=active_cases,serious_critical=serious_critical,total_cases_1m_pop=total_cases_1m_pop,deaths_1m_pop=deaths_1m_pop,total_test=total_test,test_1m_pop=test_1m_pop,population=population,date=date)
            covid_record.save()
