...
const SpendingHabitSection = ({ title }) => {
  return (
    <>
      <SmallContainer>
        ...
        <div className="singleline-chart-card-wrapper">
          <SingleChart
            title={"State Name} changes in all Consumer Spending"}
            subtitle={"Updated: {Build Date}"}
            chartDiv="state-spending-habit-chart"
            stokeColor="#116083"
          >
...
export default SpendingHabitSection
